...
const PdfExport = (props: IProps) => {
  const { triggerPDFExport, setTriggerPDFExport } = props;
          ...
          <Alert
            ...
            description={
              <p className="text-justify">
                ...
                their original, unaltered form as recorded in the Facebook Accounts Centre. The data
                remains exactly as it was retrieved, ensuring complete accuracy and authenticity.;
              </p>
            }
            type="info"
          />
